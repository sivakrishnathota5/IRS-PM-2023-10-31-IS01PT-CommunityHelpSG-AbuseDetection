        ...
        if request.user.is_authenticated:
            if request.method == 'POST':
                ...
                if comment_form.is_valid():
                    ...
                    new_comment.Sentment = "Love"
                    new_comment.isabuse_text = 1 
                    new_comment.save()
...
def new_subject(request):
    ...
    if request.method == 'POST':
        ...
        if subject_form.is_valid():
            ...
            new_subject.isabuse_image=1
            new_subject.category="SCIENCE - TECHNOLOGY"
            new_subject.isabuse_text=1;
            new_subject.Sentment="Love"
